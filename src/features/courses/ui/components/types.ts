...
export type CoursItem = Course;

export const COURS_CATALOGUE: CoursItem[] = [
  {
    id: 'course-1',
  ...
  },
  {
    ...
    description: 'Analyse des decisions d\'entreprise dans un contexte globalisé et digital. Consolidation de la gouvernance et études de cas réels d\'Afrique de l\'Ouest.',
