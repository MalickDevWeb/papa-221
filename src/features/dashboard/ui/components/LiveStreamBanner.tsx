  ...
  return (
    ...
    >
      <div className="relative z-10 flex items-center gap-5 text-left w-full md:w-auto">
        <div className="w-14 h-14 rounded-2xl bg-white/15 border border-white/20 text-white flex items-center justify-center font-black animate-pulse shadow-inner shrink-0">
