...
export function SecuritySubSidebar({ activeTab, onSelectTab, isCollapsed, onToggleCollapse }: Props) {
  const menuItems = [
    { id: 'audit', label: 'Piste d\'Audit', icon: 'security' },
    { id: 'terminals', label: 'Bornes & Lecteurs', icon: 'edgesensor_high' },
    { id: 'realtime', label: 'Flux Temps Réel', icon: 'sync' },
    { id: 'keys', label: 'Clés & Cryptographie', icon: 'vpn_key' },
  ];
