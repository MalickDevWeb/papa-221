...
export function NotificationsSubSidebar({ activeTab, onSelectTab, isCollapsed, onToggleCollapse }: Props) {
  const menuItems = [
    { id: 'mass-send', label: 'Diffusion de Masse', icon: 'campaign' },
    { id: 'emergency', label: 'Alertes d\'Urgence', icon: 'emergency_home' },
    { id: 'history', label: 'Historique & Stats', icon: 'history_toggle_off' },
  ];
