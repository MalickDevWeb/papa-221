...
export function StudentSubSidebar({ activeTab, onSelectTab, isCollapsed, onToggleCollapse }: Props) {
  const menuItems = [
    { id: 'annuaire', label: 'Annuaire & DataGrid', icon: 'analytics' },
    { id: 'import', label: 'Importation Excel', icon: 'cloud_upload' },
    { id: 'profil360', label: 'Profil Élève 360°', icon: 'account_circle' },
  ];
