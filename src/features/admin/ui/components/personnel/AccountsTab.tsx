  ...
  return (
    <div className="space-y-4" id="accounts-tab-root">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-4" style={{ width: '616px' }}>
          ...
          <div className="bg-white border border-neutral-200 rounded-2xl overflow-hidden shadow-xs" style={{ width: '615px' }}>
