...
export function FinancesSubSidebar({ activeTab, onSelectTab, isCollapsed, onToggleCollapse }: Props) {
  const menuItems = [
    { id: 'ecolages', label: 'Statuts Écolages', icon: 'account_balance_wallet' },
    { id: 'expenses', label: 'Journal des Dépenses', icon: 'payments' },
    { id: 'reports', label: 'Bilans & Exports', icon: 'analytics' },
    { id: 'recovery', label: 'Actions de Recouvrement', icon: 'electric_bolt' },
  ];
