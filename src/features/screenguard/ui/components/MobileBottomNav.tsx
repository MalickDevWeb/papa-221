...
export function MobileBottomNav({ activeTab, onSelectTab, onLogout }: Props) {
  ...
  return (
    <>
      <div id="mobile-bottom-nav" className="fixed bottom-0 left-0 right-0 h-[72px] bg-white/95 backdrop-blur-md border-t border-slate-200/60 shadow-2xl z-50 px-3 flex items-center justify-between">
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="fixed inset-0 bg-slate-950/95 backdrop-blur-md z-[999] flex flex-col p-6 text-white"
          >
